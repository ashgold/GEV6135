...
FILES = {
    ...
    'A2': ['knn.py', 'knn.ipynb'],
    'A3': ['linear_classifier.py', 'linear_classifier.ipynb',
           'svm_best_model.pt', 'softmax_best_model.pt'],
    'A4': ['two_layer_net.py', 'two_layer_net.ipynb', 'nn_best_model.pt'],
    'A5': ['fully_connected_networks.py', 'fully_connected_networks.ipynb',
           'best_two_layer_net.pt', 'best_overfit_five_layer_net.pt'],
    'A6': ['convolutional_networks.py', 'convolutional_networks.ipynb',
           'overfit_deepconvnet.pt', 'half_minute_deepconvnet.pt'],
    'A7': ['pytorch_autograd_and_nn.py', 'pytorch_autograd_and_nn.ipynb',
